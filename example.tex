...
\subtitle{an explanation of the \texttt{slideshow} document class}
\author{
  Matthew Nazari \\
...
Notice that it is a subslide of slide \autoref{subslide}. \par
...
% \headerslide{Notes at {\href{mailto:matthewnazari@college.harvard.edu}{bitly.com/329s}}}

% \slide[Why I love bella]
% Putting a label here
...
% \slide[Slide 2]
% So yay, ref (\autoref{slide:asdasd})
